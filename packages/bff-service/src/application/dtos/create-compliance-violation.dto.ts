...
export function parseCreateComplianceViolationDto(raw: unknown): CreateComplianceViolationDto | null {
  ...
  return {
    title,
    severity: severity as CreateComplianceViolationDto["severity"],
  };
}
